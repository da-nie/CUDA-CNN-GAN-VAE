...
// cTensor_LocalImage.Print("Local Image");
 ...
 size_t kernel_matrix_x=local_input_x*local_input_y;
 size_t kernel_matrix_y=((local_input_y-kernel_y)/step_y+1)*((local_input_x-kernel_x)/step_x+1);

 printf("Kernel Size:%i x %i\r\n",kernel_matrix_y,kernel_matrix_x);

 CTensor<type_t> KernelMatrix(kernel_z,kernel_matrix_y,kernel_matrix_x);
