...
//----------------------------------------------------------------------------------------------------
/*!создать слой
\param[in] upsampling_y Коэффициент расжатия по Y
\param[in] upsampling_x Коэффициент расжатия по X
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
void CNetLayerUpSampling<type_t>::SetTimeStep(uint32_t index,uint32_t time_step)
{
}
