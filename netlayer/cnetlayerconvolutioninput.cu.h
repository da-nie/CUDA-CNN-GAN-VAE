...
void CNetLayerConvolutionInput<type_t>::Create(uint32_t size_z,uint32_t size_y,uint32_t size_x,uint32_t batch_size)
{
 ...
 cTensor_H=CTensor<type_t>(BatchSize,size_z,size_y,size_x);
}
//----------------------------------------------------------------------------------------------------
...
void CNetLayerConvolutionInput<type_t>::GetOutput(CTensor<type_t> &output)
{
 ...
 if (output.GetSizeW()!=cTensor_H.GetSizeW()) throw("void CNetLayerConvolutionInput<type_t>::GetOutput(CTensor<type_t> &output) - ошибка размерности тензора output!");
 output=cTensor_H;
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
void CNetLayerConvolutionInput<type_t>::SetTimeStep(uint32_t index,uint32_t time_step)
{
}
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
void CNetLayerConvolutionInput<type_t>::PrintInputTensorSize(const std::string &name)
{
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
void CNetLayerConvolutionInput<type_t>::PrintOutputTensorSize(const std::string &name)
{
