...
//----------------------------------------------------------------------------------------------------
/*!создать слой
\param[in] prev_layer_a_ptr Указатель на класс предшествующего слоя A (NULL-слой входной)
\param[in] prev_layer_b_ptr Указатель на класс предшествующего слоя B (NULL-слой входной)
