...
//----------------------------------------------------------------------------------------------------
template<class type_t>
void CNetLayerDropOut<type_t>::EnableEMA(bool state)
{
 EMAEnabled=true;
}
//----------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
bool CNetLayerDropOut<type_t>::LoadEMAWeight(IDataStream *iDataStream_Ptr,bool check_size)
{
 DropOut=iDataStream_Ptr->LoadDouble();
 return(true);
}
...
//----------------------------------------------------------------------------------------------------
template<class type_t>
bool CNetLayerDropOut<type_t>::SaveEMAWeight(IDataStream *iDataStream_Ptr)
{
 iDataStream_Ptr->SaveDouble(DropOut);
 return(true);
}
